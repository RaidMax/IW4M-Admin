...
public class ParserL4D2SM : IParserDefinition
{
    ...
    public void Configure(IRConParser rconParser, IEventParser eventParser)
    {
        ...
        rcon.DefaultDvarValues.Add("bugfix_no_version", Engine);
        ...
        rcon.OverrideDvarNameMapping.Add("version", "bugfix_no_version");
        ...
        rcon.CommandPrefixes.Kick = "sm_kick #{0} {1}";
        rcon.CommandPrefixes.Ban = "sm_kick #{0} {1}";
        rcon.CommandPrefixes.TempBan = "sm_kick #{0} {1}";
        rcon.CommandPrefixes.Say = "sm_say {0}";
        rcon.CommandPrefixes.Tell = "sm_psay #{0} \"{1}\"";
        ...
        rconParser.GameName = Server.Game.L4D2;
