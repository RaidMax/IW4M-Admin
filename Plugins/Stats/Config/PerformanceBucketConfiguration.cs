...
// PerformanceBucketCodes moved to SharedLibraryCore.Helpers so the shared
// PerformanceBucketClassifier (also in SharedLibraryCore) can reuse the same
// normaliser. Update consumers to `using SharedLibraryCore.Helpers;`.
