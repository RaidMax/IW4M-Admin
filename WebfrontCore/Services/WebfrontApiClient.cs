...
namespace WebfrontCore.Services
{
    public class WebfrontApiClient(HttpClient httpClient) : IWebfrontApiClient
    {
            ...
            QueryHelpers.Models.BanInfoRequest request)
        {
            ...
            return httpClient
                .GetFromJsonAsync<SharedLibraryCore.Helpers.ResourceQueryHelperResult<QueryHelpers.Models.BanInfo>>(
        ...
        public async Task<IEnumerable<QueryHelpers.Models.ClientResourceResponse>> GetClientsAsync(
            QueryHelpers.Models.ClientResourceRequest request)
        {
            ...
            var response =
                await httpClient
                    .GetFromJsonAsync<
                        SharedLibraryCore.Helpers.ResourceQueryHelperResult<WebfrontCore.QueryHelpers.Models.ClientResourceResponse>>(
